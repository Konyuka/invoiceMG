        ...
        <div class="relative overflow-hidden">
            ...
            <div class="bg-gray-900 pt-6">
                ...
                <div class="flex items-center flex-1">
                    ...
                    <div v-if="canLogin" class="hidden space-x-8 md:flex md:ml-10">
                    <a v-if="$page.props.user" :href="route('dashboard')" class="text-base font-medium text-white hover:text-gray-300">Product</a>
                    </div>
                </div>
                <div v-if="canLogin" class="hidden md:flex md:items-center md:space-x-6">
                    <a :href="route('login')" class="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-white bg-gray-600 hover:bg-gray-700">
                        Login
                    </a>
            ...
            <div class="bg-gray-900 p-20 lg:overflow-hidden ">
                <div class="mx-auto max-w-7xl lg:px-8">
                <div class="lg:grid lg:grid-cols-2 lg:gap-8">
                    <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                    <div class="lg:py-24">
                        <span  class="inline-flex items-center text-white bg-black rounded-full p-1 pr-2 sm:text-base lg:text-sm xl:text-base">
                        <span class="px-3 py-0.5 text-white text-xs font-semibold leading-5 uppercase tracking-wide bg-gradient-to-r from-teal-500 to-cyan-600 rounded-full">Welcome</span>
                        <span class="ml-4 text-sm">Send Invoices With Ease</span>
                        ...
                        <span class="pb-3 block bg-clip-text text-transparent bg-gradient-to-r from-teal-200 to-cyan-400 sm:pb-5">Manager</span>
                        </h1>
                        <p class="text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl">
                            Send invoices on clicks or configure automations
                        </p>
